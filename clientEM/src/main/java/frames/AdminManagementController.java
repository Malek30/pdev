...
public class AdminManagementController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		for (Mission m : elist)
		{
			data.add(new Mission(m.getIdMission(),m.getTitle(),m.getDescription(),m.getSkills(),m.getField(),m.getStartDate(),m.getEndDate(),m.getPrice(),m.getState(),m.getMissionType(),m.getEmployer()));
		}
